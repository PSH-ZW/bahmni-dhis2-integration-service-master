...
describe('App', () => {
  ...
  it('should dispatch hideSpinner and getSession on didMount', () => {
    ...
    const spinnerFalse = actions.expects('hideSpinner')
      .withArgs(false)
      .returns({ type: '' });

    const spinnerTrue = actions.expects('hideSpinner')
      .returns({ type: '' });

    const getSession = actions.expects('getSession')
