...
class SyncDashboard extends React.Component {
  ...
  async onClickWithDateRange(unique_ref_prefix, mappingName, startDate, endDate) {
    this.props.syncDetails[mappingName].status = 'pending';
    this.setState({ syncDetails: this.props.syncDetails });
    const formattedStartDate = this.props.syncDetails[mappingName].startDate != null ? (`${this.props.syncDetails[mappingName].startDate.getFullYear()
    ...
    const formattedEndDate = this.props.syncDetails[mappingName].endDate != null ? (`${this.props.syncDetails[mappingName].endDate.getFullYear()
  ...
  renderMappingNames() {
    const unique_ref_prefix = 'prefix_';
    return (
