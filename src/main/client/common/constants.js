...
export const auditLogEventDetails = {
  ...
  EXPORT_ALL_MAPPINGS: { patientUuid: null, eventType: 'EXPORT_ALL_MAPPINGS', message: 'EXPORT_ALL_MAPPINGS_MESSAGE', module: audit.LABEL },
  IMPORT_MAPPING_SERVICE: { patientUuid: null, eventType: 'IMPORT_MAPPING_SERVICE', message: 'IMPORT_MAPPING_SERVICE_MESSAGE', module: audit.LABEL }
};
